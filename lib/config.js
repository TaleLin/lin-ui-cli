...
exports.CNPM_BASE_URL = exports.CORE_DIRS = exports.MINI_PROGRAM_LIN_UI_DIR = exports.NODE_MODULES_LIN_UI_DIR = exports.MINI_PROGRAM_DIR_NAME = exports.NODE_MODULES_DIR_NAME = exports.LIN_UI_DIR = exports.USER_CONFIG_DIR = exports.BASE_DIR = exports.CLI_VERSION = void 0;
const file_handle_1 = require("./file-handle");
exports.CLI_VERSION = require('../package.json')['version'];
exports.BASE_DIR = process.cwd();
exports.USER_CONFIG_DIR = exports.BASE_DIR + '/lin.config.json';

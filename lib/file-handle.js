...
exports.checkFileExists = exports.copyFolder = exports.deleteFolderRecursive = exports.parseJsonFile = exports.parseJsonFiles = exports.readDirGetFile = exports.readDirPath = void 0;
...
function copyFolder(currentDir, targetDir) {
            ...
            if (readCurrentFile && !readTargetFile) {
                ...
                if (file.isFile()) {
                    ...
                    try {
                        ...
                        consola_1.default.warn('权限不足', error);
                    }
                }
            }
            else {
                consola_1.default.error('操作失败，target文件夹已存在或current文件夹不存在');
            }
        }
    }
    if (fs_1.existsSync(currentDir)) {
        ...
        consola_1.default.withTag('需要copy的文件夹不存在').warn(currentDir);
    }
}
 ...
 */
function checkFileExists(path, data, type = enum_1.CheckFileExistsType.DIRECTORY) {
    if (!fs_1.existsSync(path)) {
        switch (type) {
            case enum_1.CheckFileExistsType.DIRECTORY:
                fs_1.mkdirSync(path);
                break;
            case enum_1.CheckFileExistsType.FILE:
